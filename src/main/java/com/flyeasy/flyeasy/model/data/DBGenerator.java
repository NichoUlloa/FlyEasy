...
public class DBGenerator {
    ...
    private static void crearTablaAerolinea(DSLContext create) {
        create.createTableIfNotExists("Aerolinea")
                ...
                .column("codigoIATA", VARCHAR(255))
                .column("imagenCorporativa", VARCHAR(255))
                .constraint(primaryKey("id")).execute();
    }
    ...
    private static void crearTablaPasajero(DSLContext create) {
        create.createTableIfNotExists("Pasajero")
                .column("id", INTEGER.identity(true))
                .column("nombreCompleto", VARCHAR(255))
                .column("documentoIdentidad", VARCHAR(255))
                .column("numeroTelefono", VARCHAR(255))
                .column("correoElectronico", VARCHAR(255))
                .column("fechaViaje", VARCHAR(255))
                .column("fechaNacimiento", VARCHAR(255))
                .column("nacionalidad", VARCHAR(255))
                .constraint(primaryKey("id")).execute();
    }
    ...
    private static void crearTablaPasaje(DSLContext create) {
        create.createTableIfNotExists("Pasaje")
                ...
                .column("tipoPasaje", VARCHAR(255))
                .column("asiento", VARCHAR(10))
                .constraint(primaryKey("id")).execute();
    }
